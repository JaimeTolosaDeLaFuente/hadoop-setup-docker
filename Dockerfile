...
# hadoop
RUN curl -s https://archive.apache.org/dist/hadoop/common/hadoop-2.9.2/hadoop-2.9.2.tar.gz | tar -xz -C /usr/local/
...
# pig
RUN curl -s https://archive.apache.org/dist/pig/pig-0.17.0/pig-0.17.0.tar.gz | tar -xz -C /usr/local
